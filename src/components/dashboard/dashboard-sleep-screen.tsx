...
export function DashboardSleepScreen({
  ...
  return (
    <button
      ...
      className={cn(
        "fixed inset-x-0 top-0 z-10 flex w-full appearance-none flex-col overflow-hidden border-0 bg-[#120f0d] bg-cover bg-center bg-no-repeat p-0 text-center transition",
